...
import {findProductById} from "../store/productsSlice.ts";
...
export const ShowProductView = () => {
    ...
    const breadcrumbs = [
        ...
        { id: product.productId, name: product.productName, href: '#' },
    ];
    return (
            ...
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                ...
                <div className="lg:max-w-lg lg:self-end">
                    ...
                    <section aria-labelledby="information-heading" className="mt-4">
                        ...
                        <div className="flex items-center">
                            <p className="text-lg text-gray-900 sm:text-xl">{formatPrice(product.unitPrice)}</p>
                        </div>
                        ...
                        <div className="mt-6 flex items-center">
                            ...
                            <p className="ml-2 text-sm text-gray-500">({product.unitsInStock}) In stock and ready to ship</p>
                        </div>
                    </section>
                </div>
                ...
                <div className="mt-10 lg:col-start-2 lg:row-span-2 lg:mt-0 lg:self-center">
                    <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg">
                        <img alt={product.productName} src={product.imageUrl} className="h-full w-full object-cover object-center" />
                    </div>
                </div>
                ...
                <div className="mt-10 lg:col-start-1 lg:row-start-2 lg:max-w-lg lg:self-start">
                    <section aria-labelledby="options-heading">
                        ...
                        <div className="mt-4 flex flex-row">
                            ...
                            <span className="mx-4 text-lg text-gray-900  w-8 h-9 flex text-center items-center justify-center rounded">{count}</span>
                            <button
                        ...
                        <div className="mt-6 text-center">
                            <a href="#" className="group inline-flex text-base font-medium">
                                ...
                                />
                                <span className="text-gray-500 hover:text-gray-700">Lifetime</span>
                            </a>
                        </div>
                    </section>
                </div>
