...
export const ShowProductView = () => {
    ...
    useEffect(() => {
        if (product) {
            dispatch(updateUnitsOnProduct({ productId: product.productId, units: count }));
        }
    ...
    const breadcrumbs = [
        ...
        { id: product.productId, name: product.productName, href: `/products/${product.productId}` },
    ];
                    ...
                    <div className="lg:max-w-lg lg:self-end">
                        ...
                        <section aria-labelledby="information-heading" className="mt-4">
                            ...
                            <div className="mt-6 flex items-center">
                                ...
                                <p className="ml-2 text-sm text-gray-500">({product.unitsInStock}) In stock and ready to
                                    ship</p>
                            </div>
                        </section>
                    </div>
                    ...
                    <div className="mt-10 lg:col-start-1 lg:row-start-2 lg:max-w-lg lg:self-start">
                        <section aria-labelledby="options-heading">
                            ...
                            <div className="mt-4 flex flex-row">
                                ...
                                <span
                                    className="mx-4 text-lg text-gray-900  w-8 h-9 flex text-center items-center justify-center rounded">{count}</span>
                                <button
